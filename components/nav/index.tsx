            ...
            {user.data && (
              <>
                ...
                <DropdownItem
                  ...
                  leftIcon={
                    <IconButton>
                      <PlusBoxMultipleOutlineIcon size="30px" />
                    </IconButton>
                  }
                  onClick={() => {
                    // router.push('/new-post');
